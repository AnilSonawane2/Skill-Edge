      ...
      <section className="flex flex-col gap-6 items-center py-8 px-3 min-h-[100vh]">
        ...
        >
          <div className="flex justify-center items-center">
            <h1 className="text-center absolute left-6 md:top-auto top-5 text-violet-500 dark:text-purple-500 md:text-4xl text-3xl font-bold after:content-[' ']  after:absolute after:-bottom-3.5 after:left-0 after:h-1.5 after:w-[60%] after:rounded-full after:bg-pink-400 dark:after:bg-pink-500">
              Profile
            </h1>
            {/* avatar */}
            <div
          ...
          <div className="w-full flex md:flex-row flex-col md:justify-between justify-center md:gap-0 gap-3">
            <button
              type="submit"
              className="py-3.5  rounded-md bg-purple-500 mt-3 text-white md:w-[48%] w-full"
