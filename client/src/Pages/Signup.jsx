      ...
      <section className="flex flex-col gap-6 items-center py-8 px-3 min-h-[100vh]">
        ...
        >
          ...
          <button
            type="submit"
            disabled={isLoading}
            className="mt-2 bg-purple-500 text-white dark:text-base-200 hover:bg-purple-300 transition-all ease-in-out duration-300 rounded-md py-2 font-[500]  text-lg cursor-pointer"
          >
          ...
          <p className="text-center font-inter text-gray-500 dark:text-slate-300">
            ...
            <Link
              to="/login"
              className="link text-pink-600 cursor-pointer"
            >
              {" "}
              Login
            </Link>
