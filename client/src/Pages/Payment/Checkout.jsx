    ...
    <Layout>
      <section className="flex flex-col gap-6 items-center py-8 px-3 min-h-[100vh]">
        <form
          ...
          className="flex flex-col dark:bg-gray-800 bg-white gap-4 rounded-lg md:py-10 py-7 md:px-8 md:pt-3 px-3 md:w-[500px] w-full shadow-xl dark:shadow-xl transition duration-300"
        >
          <div>
            <h1 className="bg-purple-500 w-full text-center py-4 text-2xl font-bold rounded-tl-lg rounded-tr-lg text-white">
              Subscription Bundle
            </h1>
            <div className="px-4 space-y-7 text-center text-gray-600 dark:text-gray-300">
              <p className="text-lg mt-5">
                ...
                <span className="text-purple-500 font-bold">1 year</span>. This
              ...
              <div className="text-xs">
                <p className="text-violet-600 dark:text-violet-500">
              ...
              <button
                type="submit"
                className="bg-purple-500  transition duration-300 w-full text-xl font-bold text-white py-2 rounded-bl-lg rounded-br-lg"
              >
                Buy now
              </button>
            </div>
