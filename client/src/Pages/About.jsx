      ...
      <section className="md:py-10 py-7 mb-10 text-white overflow-x-hidden  md:px-16 px-6 min-h-[100vh]">
        ...
        <div className="flex md:flex-row flex-col-reverse items-center justify-center md:gap-10 gap-7 w-full space-y-7">
          <div className="md:w-1/2 w-full space-y-7">
            <h1 className="text-5xl text-purple-500 md:font-bold font-semibold">
              Affordable and <span>quality education</span>
            </h1>
          ...
          <div className="md:w-1/2 w-1/7 flex items-center justify-center drop-shadow-[0_0_30px_#d485fe]">
            <img
              alt="about main image"
              className="drop-shadow-2xl transition-transform duration-500 ease-linear hover:rotate-[3deg] hover:scale-105"
              src={aboutMainImage}
            />
          </div>
        </div>
