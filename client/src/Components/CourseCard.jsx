...
export default function CourseCard({ data }) {
  ...
  return (
    <div 
      className="md:w-[22rem] w-[95%] md:h-[445px] h-[500px] shadow-xl dark:shadow-lg rounded-lg cursor-pointer group overflow-hidden bg-white dark:bg-zinc-700 transition-transform transform hover:scale-[1.01]"
    ...
    >
      <div className="relative overflow-hidden">
        ...
        <div className="absolute top-2 right-2 p-2 bg-white dark:bg-zinc-700 rounded-full">
          <FaPlay className="text-red-400 dark:text-red-400 text-xl" />
        </div>
      </div>
      <div className="p-4 md:space-y-2 space-y-3 text-gray-800 dark:text-white">
        ...
        <div className="flex items-center space-x-2">
          <FaBook className="text-violet-500 dark:text-violet-400" />
        ...
        <div className="flex items-center space-x-2">
          <FaUser className="text-violet-500 dark:text-violet-400" />
          <p className="text-base font-semibold">
